...
if __name__ == '__main__':
        ...
        for layer in range(1,zlayers+1,1):
            ...
            if avgcorr == 'y':
                if corrtile is None:
                    ...
                    avg_tile_path = '/home/dd119/Downloads/DeepCATS-master/stitching/AVG_IMG.tif'
    ...
    slack_message = 'Stitching completed in %02d:%02d:%02d:%02d' %(days, hours, minutes, seconds)

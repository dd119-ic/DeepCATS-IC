...
if __name__ == '__main__':
    ...
    parser.add_argument('-avgpath', default='/home/dd119/AtlasCCF3/average_10um.tif', dest='avgpath', type=str, help='File path for average atlas')
    parser.add_argument('-annopath', default='/home/dd119/AtlasCCF3/annotation_10um.tif', dest='annopath', type=str, help='File path for annotation atlas')
    ...
    parser.add_argument('-movingpts', default=False, type=str, dest='movingpts', help='path for moving points')
    ...
    # Start with Rigid
    rigidParameterMap = sitk.ReadParameterFile(os.path.join('/home/dd119/AtlasCCF3/parametermaps', rigidfile))
    parameterMapVector.append(rigidParameterMap)

    # Start with Affine
    affineParameterMap = sitk.ReadParameterFile(os.path.join('/home/dd119/AtlasCCF3/parametermaps', affinefile))
    parameterMapVector.append(affineParameterMap)

    # Add BSpline
    bsplineParameterMap = sitk.ReadParameterFile(os.path.join('/home/dd119/AtlasCCF3/parametermaps', bsplinefile))
    if args.fixedpts:
